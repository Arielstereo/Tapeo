      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="flex justify-center mb-32">
          <div className="flex flex-col items-center">
            <h1 className="text-5xl font-bold text-center">TAPEO</h1>
            <Image
              src="/logo.png"
              alt="Logo"
              width={200}
            ...
            />
            <h2 className="text-xl font-semibold">Drinks and food</h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mb-16">
          <div className="text-center">
            <h1 className="bolder">
              <Link
                href="/comidas"
                className="fondo-irregular temple-action-btn"
              >
                COMIDAS
              </Link>
            </h1>
              ...
              >
                <g fill="none">
                  <rect
                    width="256"
                    height="256"
                    fill="url(#IconifyId197476372ba8f98406)"
                    rx="60"
                  />
                  <rect
                    width="256"
                    height="256"
                    fill="url(#IconifyId197476372ba8f98407)"
                    rx="60"
                  />
                  <path
                    fill="#fff"
                  ...
                  <defs>
                    <radialGradient
                      id="IconifyId197476372ba8f98406"
                      cx="0"
                      cy="0"
                      r="1"
                    ...
                    <radialGradient
                      id="IconifyId197476372ba8f98407"
                      cx="0"
                      cy="0"
                      r="1"
